...
import variable from "./../variables/gostream";
...
export default (variables /*: * */ = variable) => {
    ...
    const headerTheme = {
                ...
                ".transparent": {
                    ...
                    "NativeBase.Icon": {
                        ...
                        fontSize: platform === "ios" && variables.platformStyle !== "material" ?
                            variables.iconHeaderSize + 1 : variables.iconHeaderSize,
                        marginTop: 0,
                        marginRight: 2,
                        marginLeft: 1,
                        paddingTop: 1
                    ...
                    "NativeBase.IconNB": {
                        color: variables.toolbarBtnColor,
                        fontSize: platform === "ios" && variables.platformStyle !== "material" ?
                            variables.iconHeaderSize + 1 : variables.iconHeaderSize - 2,
                        marginTop: 0,
                        marginRight: 2,
                        marginLeft: 1,
                        paddingTop: 1
        ...
        height: variables.platform === "ios" && variables.platformStyle === "material" ?
            variables.toolbarHeight + 10 : variables.toolbarHeight,
        elevation: 3,
